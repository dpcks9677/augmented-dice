...
golden.activeMutations[1].eh4 = "golden-die";
...
couple.activeMutations[1].eh9 = "couple-dice";
...
sevens.activeMutations[1].threes = "prime-numbers";
sevens.activeMutations[1]["l-straight"] = "high-dice";
...
everyLittle.activeMutations[1].q7 = "every-little";
...
noTime.activeMutations[1].q2 = "no-time-to-waste";
...
noTimeSuccess.activeMutations[1].q2 = "no-time-to-waste";
...
momentum.activeMutations[1].eh3 = "momentum";
...
nozdormu.activeMutations[1].q10 = "nozdormu";
...
penalty.activeMutations[1].eh12 = "equivalent-exchange";
